...
/***************** Full Width Section ******************/
	...
	$('.full-width-section').each(function(){
		if(!$(this).parent().hasClass('span_9') && !$(this).parent().hasClass('span_3') && $(this).parent().attr('id') != 'sidebar-inner' && $(this).parent().attr('id') != 'portfolio-extra'){
			...
			else if($(this).index() == '0' && $('#page-header-bg').length == 0){
...
if($('#page-header-bg[data-parallax="1"]').length > 0) {
	...
	img.onload = function() {
	  ...
	  $('#page-header-bg[data-parallax="1"]').css({'top': (logoHeight+headerPadding+headerResizeOffExtra+extraHeight-extraDef+secondaryHeader)  + 'px' });
	  ...
	  $('#page-header-bg[data-parallax="1"] .span_6').css({ 
			...
			'top' : ($scrollTop*-0.45) + (logoHeight+headerPadding2+headerResizeOffExtra+extraHeight-extraDef+secondaryHeader) + ((pageHeaderHeight/2) - (pageHeadingHeight))  + 22 +"px"
	   });
